...
plt.plot([1, len(rho)], [threshold95, threshold95], "--")
plt.title("Variance explained by principal components")
plt.xlabel("Principal component")
plt.ylabel("Variance explained")
plt.legend(["Individual", "Cumulative", "Threshold 90%", "Treshhold 95%"])
plt.grid()
plt.show()

print("To explain more than 95% variance we need 4 principal components.\n")
