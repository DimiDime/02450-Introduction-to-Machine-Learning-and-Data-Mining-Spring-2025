...
print("Correlation Similarity between Volatile acidity & Citric acidity: ", similarity(Xnorm[0], Xnorm[1], 'Correlation'))

print("Correlation Similarity between Volatile acidity & Residual sugar: ", similarity(Xnorm[0], Xnorm[2], 'Correlation'))

print("Correlation Similarity between Volatile acidity & Chlorides: ", similarity(Xnorm[0], Xnorm[3], 'Correlation'))


print("Correlation Similarity between Volatile acidity & Total sulfur dioxide: ", similarity(Xnorm[0], Xnorm[7], 'Correlation'))

print("Correlation Similarity between Volatile acidity & Free sulfur dioxide: ", similarity(Xnorm[0], Xnorm[6], 'Correlation'))

print("Correlation Similarity between Volatile acidity & Chlorides: ", similarity(Xnorm[0], Xnorm[5], 'Correlation'))
